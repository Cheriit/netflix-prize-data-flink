...
class MovieRatingProcessFunction extends ProcessWindowFunction[MovieRatingAggregated, MovieRatingResult, Int, TimeWindow]{
  override def process(key: Int, context: Context, elements: Iterable[MovieRatingAggregated], out: Collector[MovieRatingResult]): Unit =
