...
class MovieRatingAnomalyProcessFunction extends ProcessWindowFunction[MovieRatingAnomalyAggregated, MovieRatingAnomaly, String, TimeWindow]{
  override def process(key: String, context: Context, elements: Iterable[MovieRatingAnomalyAggregated], out: Collector[MovieRatingAnomaly]): Unit =
